- 2026-06-26 Pit Debrief Box Delta repair-exclusion follow-up landed:
  - Pit Debrief Box Delta now compares actual boxed elapsed time against a debrief-only fuel/tyre/boxed-overhead service target that excludes optional and mandatory repair duration, so leaving before optional repairs complete no longer creates a misleading large negative Box Delta.
