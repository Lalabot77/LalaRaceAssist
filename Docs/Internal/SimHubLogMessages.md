...
- **`[LalaPlugin:Leader Lap] holding overall leader rolling avg reason=... age_s=... avg_s=...`** — Temporary missing/unsampleable overall-P1 feed is using the bounded held rolling average for projection continuity.
- **`[LalaPlugin:Leader Lap] held overall leader pace expired reason=... age_s=... max_s=... – returning 0`** — Bounded hold expired without fresh overall-P1 authority; leader lap fails closed.
