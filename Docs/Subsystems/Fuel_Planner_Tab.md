...
- Strategy tyre slider basis remains profile-owned: planner tyre time now seeds from active profile tyre time on profile load/switch and refreshes on active-profile tyre learn updates (no manual slider interaction required).
