...
Subsystem docs are the technical/canonical implementation layer. Product docs may use outside-in names such as Standing Start Assist or Driver Tagging; subsystem docs preserve implementation truth and existing contracts.
...
| Pit System | [Pit Timing and Pit Loss](Pit_System/Pit_Timing_And_PitLoss.md), [Pit Entry Assist](Pit_System/Pit_Entry_Assist.md), [Pit Commands and Fuel/Tyre Control](Pit_System/Pit_Commands_And_Fuel_Control.md), [Fuel modes CSV](Pit_System/FuelModesLogicCSV.csv), [Tyre modes CSV](Pit_System/TyreModesLogicCSV.csv), [Track Markers](Pit_System/Track_Markers.md) | Pit System owns pit timing, entry, box, command, fuel/tyre, debrief, and marker flows. |
...
| Standing Start Assist | [Launch Mode](Standing_Start_Assist/Launch_Mode.md) | Public docs say Standing Start Assist; technical implementation may still say Launch Mode. |
...
| Developer Tools | [Trace Logging](Developer_Tools/Trace_Logging.md) | Diagnostics observe existing systems; they do not own runtime behavior. |
