...
This subsystem documents **session summary / per-lap race traces**. Launch trace lifecycle and Launch Analysis file handling are owned by Launch Mode (`Docs/Subsystems/Race_Starts/Launch_Mode.md`).
