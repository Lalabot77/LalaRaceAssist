...
Dash Control binding actions include `LalaLaunch.DarkModeBrightnessDecrease`, `LalaLaunch.DarkModeBrightnessIncrease`, `LalaLaunch.ShiftAssistToggle`, `LalaLaunch.StrategyContingencyAdd1L`, and `LalaLaunch.StrategyContingencyRemove1L`.
