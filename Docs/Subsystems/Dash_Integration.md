...
- Pit service regulation math is plugin-owned. Dashboards consume existing pit/strategy exports (`Fuel.Live.TotalStopLoss`, `Pit.Box.*`, `StrategyDash.*`, `PreRace.*`) and must not reimplement Default/IMSA/NEC fuel-vs-tyre timing formulas.
