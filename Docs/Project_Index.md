...
Branch: work
Current note: Pit Debrief tyre-evidence reset follow-up docs are current; reset-in-lane cases clear prior-stop tyre evidence before the next boxed-target latch.
